# Session: Saint-Croix Lake (Morning)
**Date:** 2026-04-08
**Level:** 31
**Location Level:** 30
...
| | Amount |
|---|--------|
| Credits (Start) | ~663,458 |
| Credits (End) | ~684,764 |
| Net Income | +31,106 |
| License Cost | Advanced (already active) |
| Travel Cost | ~9,800 |
| **True Profit** | ~+21,306 |
...
- 505 lbs total keep in ~1 hour real time (5:30 AM to 9:24 AM in-game)
...
|------|--------|--------|------|--------------|
| Lake Sturgeon | 42.809 lb | Duck Mussel Meat, bottom rod | Cat Boxer | Keep |
| Trophy Northern Pike | 21.82 lb | Triple Runner 8 ft #5/0 | Salmonster | Keep |
| Smallmouth Bass (many) | 2-3 lb | Triple Runner, drop-jig technique | Salmonster | Keep |
| Blue Catfish (several) | Various | Triple Runner + bottom rods | Multiple | Keep |
| Trout (a few) | Various | Triple Runner | Salmonster | Keep |
...
## Triple Runner Technique (Documented)
- Lure: Triple Runner 8 ft #5/0 on Salmonster 8' / Kraken 8000 SE
- Depth zone: 20-40 ft water, targeting fish 3-5 ft from bottom
- Cast: Toward central dock area with two player markers (~328 ft)
- Retrieve pattern: Drop to bottom → rest 3 sec → reel level 3 sec → drop/jig to bottom → rest 3 sec → smooth reel up
- Strike timing: Usually on the draw-up (reel phase)
- Species hit: Smallmouth Bass (most common), Blue Catfish, Trout, Northern Pike

## Fishing Location
- Fairytale Fishing dock, facing central dock with cruiser and smaller boat
- Player position: [225.13, 76.13] on map
- 9:47 AM, 48°F, N 1.8 mph wind, clear
- Fish Species: 29/49
